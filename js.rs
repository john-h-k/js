...
// sha3: d2df86e662145adeca5e6f053c15f78e864a16411b18ca7b67a3cd451126e439
...
mod __parse__Expression {
    ...
    pub(crate) enum __Symbol<'input>
     {
        Variant0(&'input str),
        Variant1(ExpressionNode),
        Variant2(LiteralNode),
        Variant3(Statement),
        Variant4(String),
    }
    const __ACTION: &[i8] = &[
    ...
    ) -> __Symbol<'input>
    {
        match __token_index {
            0 | 1 => match __token {
                Token(1, __tok0) | Token(0, __tok0) if true => __Symbol::Variant0(__tok0),
                _ => unreachable!(),
            },
            _ => unreachable!(),
        }
    ...
    impl ExpressionParser {
        ...
        >(
            &self,
            input: &'input str,
        ) -> Result<ExpressionNode, __lalrpop_util::ParseError<usize, Token<'input>, &'static str>>
        {
    ...
    >(
        ...
        _: core::marker::PhantomData<(&'input ())>,
    ) -> Option<Result<ExpressionNode,__lalrpop_util::ParseError<usize, Token<'input>, &'static str>>>
    {
    ...
    {
        // Literal = StringLiteral => ActionFn(4);
    ...
    {
        // Statement = Expression, ";" => ActionFn(2);
...
>(
    input: &'input str,
    (_, __0, _): (usize, ExpressionNode, usize),
) -> ExpressionNode
{
    __0
}
...
>(
    input: &'input str,
    (_, e, _): (usize, ExpressionNode, usize),
